...
Uma universidade possui vários laboratórios.
Cada laboratório possui computadores (hardware) para as aulas.
Cada computador possui vários softwares instalados.
Um usuário cadastrado no sistema pode relatar problemas (hardware e/o software)
que ele observou, para informar à equipe de manutenção.
A equipe de manutenção pode listar várias informações disponibilizadas pelo
sistema "SIMCO - Sistema de Manutenção de Computadores".
Dessa forma, foi pedido a você que crie um sistema para:
